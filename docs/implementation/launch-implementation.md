...
- Funnel Platform picker exposes pump.fun (working) and SPL (coming soon); EVM is removed from selection. Client funnel is a shared shell (metadata + Launch Options) plus `components/launch/platforms/pumpfun/` labeled **pump.fun Configuration**.
