...
export function DashboardHeader({
  ...
  const progressPercent = header.isComplete
    ? 100
    : Math.min((header.realSolReserves / GRADUATION_SOL_THRESHOLD) * 100, 99.9);
    ...
    <>
      <div className="flex items-center gap-6 px-1 py-2 flex-wrap @xl/main:flex-nowrap">
        ...
        <div className="flex flex-col gap-0.5 shrink-0">
          ...
          <div className="flex items-end gap-2">
            {header.marketCapUsd > 0 ? (
              <span className="font-bold text-2xl tabular-nums font-mono">
            ...
            {header.marketCapUsd > 0 && (
              <span className="text-base tabular-nums font-mono text-muted-foreground mb-0.5">
                {formatMarketCap(header.marketCapSol)} SOL
              </span>
            )}
          </div>
        ...
        <div className="flex flex-col gap-0.5 shrink-0">
          ...
          <span className=" tabular-nums font-mono text-muted-foreground mt-0.5">
